...
# grothesk.io/app-with-plugins-operator-bundle:$VERSION and grothesk.io/app-with-plugins-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= grothesk.io/app-with-plugins-operator
